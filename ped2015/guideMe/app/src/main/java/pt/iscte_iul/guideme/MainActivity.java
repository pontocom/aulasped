...
public class MainActivity extends ActionBarActivity implements OnMapReadyCallback {
    ...
    public static String APIURL = "http://172.17.18.208:3000";
    ...
    private class getPOIs extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params)
        {
            ...
            try {
                ...
                HttpResponse httpResponse = httpclient.execute(new HttpGet("http://172.17.18.208:3000" + "/poi/range/"+latitude+"/"+longitude+"/"+myRange*1000));
